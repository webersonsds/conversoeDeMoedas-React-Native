...
export default function App() {
  ...
  const [valorConvertido, setValoConvertido] = useState(0)
  ...
  async function converter() {
    if (moedaSelecionada === null || moedaBValor === 0) {
      alert('Por favor seleciobe uma moeda')
      return;
    }
    ...
    setValoConvertido(`R$ ${resultado.toFixed(2)}`)
    setValorMoeda(moedaBValor)

//Fecha o teclado caso ele esteja aberto
